<%@ Page Title="Add Product" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="addmember.aspx.cs" Inherits="Stock_Management_System.dash.addMember" %>
        ...
        <div class="row p-3">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="d-inline">
                        <asp:Button ID="addMember_button" runat="server" Text="Add Member" CssClass="btn btn-primary" onClick="addMember_button_Click" />
                    </div>
                </div>
            </div>
        </div>
